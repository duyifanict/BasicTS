...
def parse_args():
    ...
    parser.add_argument('-ckpt', '--checkpoint', default='checkpoints/STID/PEMS04_100_12_12/40de8ae98d3fb912c552c42197c02428/STID_best_val_MAE.pt')
    parser.add_argument('-i', '--input_data_file_path', default='./in_short.csv')
