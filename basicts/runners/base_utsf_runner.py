...
class BaseUniversalTimeSeriesForecastingRunner(BaseIterationRunner):
    ...
    @torch.no_grad()
    @master_only
    def inference(self, save_result_path: str = '') -> list:
        """Inference process.
        ...
        forward_return = self.inference_forward(data, epoch=None, iter_num=None, train=False)
        ...
        if save_result_path:
            ...
            np.savetxt(save_result_path, prediction, delimiter=',')
    ...
    def inference_forward(self, data: Dict, **kwargs) -> Dict:
        """
